    ...
    fn new(
        ...
        match attrs {
            ...
            PerformanceAttributes::Osu(OsuPerformanceAttributes {
                ...
                stars: pp_difficulty.stars,
                maxCombo: Some(pp_difficulty.max_combo),
                aimStrain: Some(pp_difficulty.aim),
                speedStrain: Some(pp_difficulty.speed),
                flashlightRating: Some(pp_difficulty.flashlight),
                sliderFactor: Some(pp_difficulty.slider_factor),
                nCircles: Some(pp_difficulty.n_circles),
                nSliders: Some(pp_difficulty.n_sliders),
                nSpinners: Some(pp_difficulty.n_spinners),
                ar,
                cs,
                hp,
                od,
